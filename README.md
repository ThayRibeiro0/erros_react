...
### Installation
I Create the project with `npm create vite@latest` and into in the project using `cd erros_react` and below have the link of the things that I used in this project or that you can use:
...
## Referência
- [Youtube] - 5 ERROS DE INICIANTES NO REACT.JS - NÃO COMETA ESTES ERROS NO REACT | Matheus Battisti - Hora de Codar - (https://www.youtube.com/watch?v=iulq3G5xroU&list=PLnDvRpP8BneyVA0SZ2okm-QBojomniQVO&index=47)
